...
static INPUT_PORTS_START(stkbd)
	...
	PORT_START("MOUSEX")
	PORT_BIT( 0xff, 0x00, IPT_MOUSE_X ) PORT_SENSITIVITY(5) PORT_KEYDELTA(5) PORT_MINMAX(0, 255) PORT_PLAYER(1) // MESSUI 2024-09-28

	PORT_START("MOUSEY")
	PORT_BIT( 0xff, 0x00, IPT_MOUSE_Y ) PORT_SENSITIVITY(5) PORT_KEYDELTA(5) PORT_MINMAX(0, 255) PORT_PLAYER(1) // MESSUI 2024-09-28
