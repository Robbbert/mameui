...
private:
	...
	required_device<i82586_device> m_edlc;
...
void sun2_state::vmetype1space_map(address_map &map)
{
	...
	map(0x7f2000, 0x7f2000).rw(m_scc[1], FUNC(z80scc_device::cb_r), FUNC(z80scc_device::cb_w));
	map(0x7f2002, 0x7f2002).rw(m_scc[1], FUNC(z80scc_device::db_r), FUNC(z80scc_device::db_w));
	map(0x7f2004, 0x7f2004).rw(m_scc[1], FUNC(z80scc_device::ca_r), FUNC(z80scc_device::ca_w));
	map(0x7f2006, 0x7f2006).rw(m_scc[1], FUNC(z80scc_device::da_r), FUNC(z80scc_device::da_w));
...
void sun2_state::sun2vme(machine_config &config)
{
	...
	m_scc[1]->out_int_callback().set_inputline(m_maincpu, M68K_IRQ_6);
	...
	rs232b.dcd_handler().set(m_scc[1], FUNC(z80scc_device::dcdb_w));
	rs232b.cts_handler().set(m_scc[1], FUNC(z80scc_device::ctsb_w));
}
...
public:
	...
	void sun2_120(machine_config &config);
